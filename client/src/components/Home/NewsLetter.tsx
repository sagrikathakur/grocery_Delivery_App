...
const NewsLetter = () => {
  return (
    <section className="bg-gray-100 py-18 px-4 sm:px-6 lg:px-8 rounded-3xl mx-auto shadow-xs mt-32 mb-20 w-full">
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <form
          onSubmit={(e) => e.preventDefault()} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" >

          <input type="email" placeholder="Enter your email" required className="flex-1 px-5 py-3.5 rounded-xl border border-app-border focus:ring bg-white text-sm transition-all " />
