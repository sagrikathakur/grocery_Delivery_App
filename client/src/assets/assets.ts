...
export const dummyAddressData = [
    { label: "Home", address: "Saket vihar Complex ", city: "Delhi ", state: "del", zip: "10001", isDefault: true, lat: 40.7128, lng: -74.006, id: "69d3652df9a340288f1a0f8c" },
    { label: "Work", address: "456 Market St ", city: "delhi ", state: "del", zip: "10002", isDefault: false, lat: 40.7128, lng: -74.006, id: "69d3652df9a340288f1a0f8d" },
];
